...
var rgb;return R.is(clr,"object")&&"h"in clr&&"s"in clr&&"b"in clr?(rgb=R.hsb2rgb(clr),clr.r=rgb.r,clr.g=rgb.g,clr.b=rgb.b,clr.hex=rgb.hex):R.is(clr,"object")&&"h"in clr&&"s"in clr&&"l"in clr?(rgb=R.hsl2rgb(clr),clr.r=rgb.r,clr.g=rgb.g,clr.b=rgb.b,clr.hex=rgb.hex):(R.is(clr,"string")&&(clr=R.getRGB(clr)),R.is(clr,"object")&&"r"in clr&&"g"in clr&&"b"in clr?(rgb=R.rgb2hsl(clr),clr.h=rgb.h,clr.s=rgb.s,clr.l=rgb.l,rgb=R.rgb2hsb(clr),clr.v=rgb.b):(clr={hex:"none"},clr.r=clr.g=clr.b=clr.h=clr.s=clr.v=clr.l=-1)),clr.toString=rgbtoString,clr},R.hsb2rgb=function(h,s,v,o){this.is(h,"object")&&"h"in h&&"s"in h&&"b"in h&&(v=h.b,s=h.s,o=h.o,h=h.h),h*=360;var R,G,B,X,C
;return h=h%360/60,C=v*s,X=C*(1-abs(h%2-1)),R=G=B=v-C,h=~~h,R+=[C,X,0,0,X,C][h],G+=[X,C,C,X,0,0][h],B+=[0,0,X,C,C,X][h],packageRGB(R,G,B,o)},R.hsl2rgb=function(h,s,l,o){this.is(h,"object")&&"h"in h&&"s"in h&&"l"in h&&(l=h.l,s=h.s,h=h.h),(h>1||s>1||l>1)&&(h/=360,s/=100,l/=100),h*=360;var R,G,B,X,C;return h=h%360/60,C=2*s*(l<.5?l:1-l),X=C*(1-abs(h%2-1)),R=G=B=l-C/2,h=~~h,R+=[C,X,0,0,X,C][h],G+=[X,C,C,X,0,0][h],B+=[0,0,X,C,C,X][h],packageRGB(R,G,B,o)},R.rgb2hsb=function(r,g,b){b=prepareRGB(r,g,b),r=b[0],g=b[1],b=b[2];var H,S,V,C;return V=mmax(r,g,b),C=V-mmin(r,g,b),H=0==C?null:V==r?(g-b)/C:V==g?(b-r)/C+2:(r-g)/C+4,H=(H+360)%6*60/360,S=0==C?0:C/V,{h:H,s:S,b:V,
toString:hsbtoString}},R.rgb2hsl=function(r,g,b){b=prepareRGB(r,g,b),r=b[0],g=b[1],b=b[2];var H,S,L,M,m,C;return M=mmax(r,g,b),m=mmin(r,g,b),C=M-m,H=0==C?null:M==r?(g-b)/C:M==g?(b-r)/C+2:(r-g)/C+4,H=(H+360)%6*60/360,L=(M+m)/2,S=0==C?0:L<.5?C/(2*L):C/(2-2*L),{h:H,s:S,l:L,toString:hsltoString}},R._path2string=function(){return this.join(",").replace(p2s,"$1")};R._preload=function(src,f){var img=g.doc.createElement("img");img.style.cssText="position:absolute;left:-9999em;top:-9999em",img.onload=function(){f.call(this),this.onload=null,g.doc.body.removeChild(this)},img.onerror=function(){g.doc.body.removeChild(this)},g.doc.body.appendChild(img),img.src=src}
;R.getRGB=cacher(function(colour){if(!colour||(colour=Str(colour)).indexOf("-")+1)return{r:-1,g:-1,b:-1,hex:"none",error:1,toString:clrToString};if("none"==colour)return{r:-1,g:-1,b:-1,hex:"none",toString:clrToString};!(hsrg[has](colour.toLowerCase().substring(0,2))||"#"==colour.charAt())&&(colour=toHex(colour));var red,green,blue,opacity,t,values,rgb=colour.match(colourRegExp);return rgb?(rgb[2]&&(blue=toInt(rgb[2].substring(5),16),green=toInt(rgb[2].substring(3,5),16),red=toInt(rgb[2].substring(1,3),16)),rgb[3]&&(blue=toInt((t=rgb[3].charAt(3))+t,16),green=toInt((t=rgb[3].charAt(2))+t,16),red=toInt((t=rgb[3].charAt(1))+t,16)),
rgb[4]&&(values=rgb[4][split](commaSpaces),red=toFloat(values[0]),"%"==values[0].slice(-1)&&(red*=2.55),green=toFloat(values[1]),"%"==values[1].slice(-1)&&(green*=2.55),blue=toFloat(values[2]),"%"==values[2].slice(-1)&&(blue*=2.55),"rgba"==rgb[1].toLowerCase().slice(0,4)&&(opacity=toFloat(values[3])),values[3]&&"%"==values[3].slice(-1)&&(opacity/=100)),rgb[5]?(values=rgb[5][split](commaSpaces),red=toFloat(values[0]),"%"==values[0].slice(-1)&&(red*=2.55),green=toFloat(values[1]),"%"==values[1].slice(-1)&&(green*=2.55),blue=toFloat(values[2]),"%"==values[2].slice(-1)&&(blue*=2.55),("deg"==values[0].slice(-3)||"°"==values[0].slice(-1))&&(red/=360),
"hsba"==rgb[1].toLowerCase().slice(0,4)&&(opacity=toFloat(values[3])),values[3]&&"%"==values[3].slice(-1)&&(opacity/=100),R.hsb2rgb(red,green,blue,opacity)):rgb[6]?(values=rgb[6][split](commaSpaces),red=toFloat(values[0]),"%"==values[0].slice(-1)&&(red*=2.55),green=toFloat(values[1]),"%"==values[1].slice(-1)&&(green*=2.55),blue=toFloat(values[2]),"%"==values[2].slice(-1)&&(blue*=2.55),("deg"==values[0].slice(-3)||"°"==values[0].slice(-1))&&(red/=360),"hsla"==rgb[1].toLowerCase().slice(0,4)&&(opacity=toFloat(values[3])),values[3]&&"%"==values[3].slice(-1)&&(opacity/=100),R.hsl2rgb(red,green,blue,opacity)):(rgb={r:red,g:green,b:blue,toString:clrToString},
rgb.hex="#"+(16777216|blue|green<<8|red<<16).toString(16).slice(1),R.is(opacity,"finite")&&(rgb.opacity=opacity),rgb)):{r:-1,g:-1,b:-1,hex:"none",error:1,toString:clrToString}},R),R.hsb=cacher(function(h,s,b){return R.hsb2rgb(h,s,b).hex}),R.hsl=cacher(function(h,s,l){return R.hsl2rgb(h,s,l).hex}),R.rgb=cacher(function(r,g,b){function round(x){return x+.5|0}return"#"+(16777216|round(b)|round(g)<<8|round(r)<<16).toString(16).slice(1)}),R.getColor=function(value){var start=this.getColor.start=this.getColor.start||{h:0,s:1,b:value||.75},rgb=this.hsb2rgb(start.h,start.s,start.b);return start.h+=.075,start.h>1&&(start.h=0,start.s-=.2,
start.s<=0&&(this.getColor.start={h:0,s:1,b:start.b})),rgb.hex},R.getColor.reset=function(){delete this.start},R.parsePathString=function(pathString){if(!pathString)return null;var pth=paths(pathString);if(pth.arr)return pathClone(pth.arr);var paramCounts={a:7,c:6,h:1,l:2,m:2,r:4,q:4,s:4,t:2,v:1,z:0},data=[];return R.is(pathString,array)&&R.is(pathString[0],array)&&(data=pathClone(pathString)),data.length||Str(pathString).replace(pathCommand,function(a,b,c){var params=[],name=b.toLowerCase();if(c.replace(pathValues,function(a,b){b&&params.push(+b)}),"m"==name&&params.length>2&&(data.push([b][concat](params.splice(0,2))),name="l",b="m"==b?"l":"L"),
...
x:mx,y:my},n:{x:nx,y:ny},start:{x:ax,y:ay},end:{x:cx,y:cy},alpha:alpha}},R.bezierBBox=function(p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y){R.is(p1x,"array")||(p1x=[p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y]);var bbox=curveDim.apply(null,p1x);return{x:bbox.min.x,y:bbox.min.y,x2:bbox.max.x,y2:bbox.max.y,width:bbox.max.x-bbox.min.x,height:bbox.max.y-bbox.min.y}},R.isPointInsideBBox=function(bbox,x,y){return x>=bbox.x&&x<=bbox.x2&&y>=bbox.y&&y<=bbox.y2},R.isBBoxIntersect=function(bbox1,bbox2){var i=R.isPointInsideBBox
...
if(null==tstr)return el._.transform;tstr=Str(tstr).replace(/\.{3}|\u2026/g,el._.transform||E);var tdata=R.parseTransformString(tstr),deg=0,dx=0,dy=0,sx=1,sy=1,_=el._,m=new Matrix;if(_.transform=tdata||[],tdata)for(var i=0,ii=tdata.length;i<ii;i++){var x1,y1,x2,y2,bb,t=tdata[i],tlen=t.length,command=Str(t[0]).toLowerCase(),absolute=t[0]!=command,inver=absolute?m.invert():0;"t"==command&&3==tlen?absolute?(x1=inver.x(0,0),y1=inver.y(0,0),x2=inver.x(t[1],t[2]),y2=inver.y(t[1],t[2]),m.translate(x2-x1,y2-y1)):m.translate(t[1],t[2]):"r"==command?2==tlen?(bb=bb||el.getBBox(1),m.rotate(t[1],bb.x+bb.width/2,bb.y+bb.height/2),
deg+=t[1]):4==tlen&&(absolute?(x2=inver.x(t[2],t[3]),y2=inver.y(t[2],t[3]),m.rotate(t[1],x2,y2)):m.rotate(t[1],t[2],t[3]),deg+=t[1]):"s"==command?2==tlen||3==tlen?(bb=bb||el.getBBox(1),m.scale(t[1],t[tlen-1],bb.x+bb.width/2,bb.y+bb.height/2),sx*=t[1],sy*=t[tlen-1]):5==tlen&&(absolute?(x2=inver.x(t[3],t[4]),y2=inver.y(t[3],t[4]),m.scale(t[1],t[2],x2,y2)):m.scale(t[1],t[2],t[3],t[4]),sx*=t[1],sy*=t[2]):"m"==command&&7==tlen&&m.add(t[1],t[2],t[3],t[4],t[5],t[6]),_.dirtyT=1,el.matrix=m}el.matrix=m,_.sx=sx,_.sy=sy,_.deg=deg,_.dx=dx=m.e,_.dy=dy=m.f,1==sx&&1==sy&&!deg&&_.bbox?(_.bbox.x+=+dx,_.bbox.y+=+dy):_.dirtyT=1}),getEmpty=function(item){var l=item[0]
...
this.d=out[1][1],this.e=out[0][2],this.f=out[1][2]},matrixproto.invert=function(){var me=this,x=me.a*me.d-me.b*me.c;return new Matrix(me.d/x,-me.b/x,-me.c/x,me.a/x,(me.c*me.f-me.d*me.e)/x,(me.b*me.e-me.a*me.f)/x)},matrixproto.clone=function(){return new Matrix(this.a,this.b,this.c,this.d,this.e,this.f)},matrixproto.translate=function(x,y){this.add(1,0,0,1,x,y)},matrixproto.scale=function(x,y,cx,cy){null==y&&(y=x),(cx||cy)&&this.add(1,0,0,1,cx,cy),this.add(x,0,0,y,0,0),(cx||cy)&&this.add(1,0,0,1,-cx,-cy)},matrixproto.rotate=function(a,x,y){a=R.rad(a),x=x||0,y=y||0;var cos=+math.cos(a).toFixed(9),sin=+math.sin(a).toFixed(9);this.add(cos,sin,-sin,cos,x,y),
this.add(1,0,0,1,-x,-y)},matrixproto.x=function(x,y){return x*this.a+y*this.c+this.e},matrixproto.y=function(x,y){return x*this.b+y*this.d+this.f},matrixproto.get=function(i){return+this[Str.fromCharCode(97+i)].toFixed(4)},matrixproto.toString=function(){return R.svg?"matrix("+[this.get(0),this.get(1),this.get(2),this.get(3),this.get(4),this.get(5)].join()+")":[this.get(0),this.get(2),this.get(1),this.get(3),0,0].join()},matrixproto.toFilter=function(){return"progid:DXImageTransform.Microsoft.Matrix(M11="+this.get(0)+", M12="+this.get(2)+", M21="+this.get(1)+", M22="+this.get(3)+", Dx="+this.get(4)+", Dy="+this.get(5)+", sizingmethod='auto expand')"},
matrixproto.offset=function(){return[this.e.toFixed(4),this.f.toFixed(4)]},matrixproto.split=function(){var out={};out.dx=this.e,out.dy=this.f;var row=[[this.a,this.c],[this.b,this.d]];out.scalex=math.sqrt(norm(row[0])),normalize(row[0]),out.shear=row[0][0]*row[1][0]+row[0][1]*row[1][1],row[1]=[row[1][0]-row[0][0]*out.shear,row[1][1]-row[0][1]*out.shear],out.scaley=math.sqrt(norm(row[1])),normalize(row[1]),out.shear/=out.scaley;var sin=-row[0][1],cos=row[1][1];return cos<0?(out.rotate=R.deg(math.acos(cos)),sin<0&&(out.rotate=360-out.rotate)):out.rotate=R.deg(math.asin(sin)),
out.isSimple=!(+out.shear.toFixed(9)||out.scalex.toFixed(9)!=out.scaley.toFixed(9)&&out.rotate),out.isSuperSimple=!+out.shear.toFixed(9)&&out.scalex.toFixed(9)==out.scaley.toFixed(9)&&!out.rotate,out.noRotation=!+out.shear.toFixed(9)&&!out.rotate,out},matrixproto.toTransformString=function(shorter){var s=shorter||this[split]();return s.isSimple?(s.scalex=+s.scalex.toFixed(4),s.scaley=+s.scaley.toFixed(4),s.rotate=+s.rotate.toFixed(4),(s.dx||s.dy?"t"+[s.dx,s.dy]:E)+(1!=s.scalex||1!=s.scaley?"s"+[s.scalex,s.scaley,0,0]:E)+(s.rotate?"r"+[s.rotate,0,0]:E)):"m"+[this.get(0),this.get(1),this.get(2),this.get(3),this.get(4),this.get(5)]}}(Matrix.prototype)
...
paperproto.getSize=function(){var container=this.canvas.parentNode;return{width:container.offsetWidth,height:container.offsetHeight}},paperproto.setSize=function(width,height){return R._engine.setSize.call(this,width,height)},paperproto.setViewBox=function(x,y,w,h,fit){return R._engine.setViewBox.call(this,x,y,w,h,fit)},paperproto.top=paperproto.bottom=null,paperproto.raphael=R;var getOffset=function(elem){var box=elem.getBoundingClientRect(),doc=elem.ownerDocument,body=doc.body,docElem=doc.documentElement,clientTop=docElem.clientTop||body.clientTop||0,clientLeft=docElem.clientLeft||body.clientLeft||0;return{
y:box.top+(g.win.pageYOffset||docElem.scrollTop||body.scrollTop)-clientTop,x:box.left+(g.win.pageXOffset||docElem.scrollLeft||body.scrollLeft)-clientLeft}};paperproto.getElementByPoint=function(x,y){var paper=this,svg=paper.canvas,target=g.doc.elementFromPoint(x,y);if(g.win.opera&&"svg"==target.tagName){var so=getOffset(svg),sr=svg.createSVGRect();sr.x=x-so.x,sr.y=y-so.y,sr.width=sr.height=1;var hits=svg.getIntersectionList(sr,null);hits.length&&(target=hits[hits.length-1])}if(!target)return null;for(;target.parentNode&&target!=svg.parentNode&&!target.raphael;)target=target.parentNode;return target==paper.canvas.parentNode&&(target=svg),
target=target&&target.raphael?paper.getById(target.raphaelid):null},paperproto.getElementsByBBox=function(bbox){var set=this.set();return this.forEach(function(el){R.isBBoxIntersect(el.getBBox(),bbox)&&set.push(el)}),set},paperproto.getById=function(id){for(var bot=this.bottom;bot;){if(bot.id==id)return bot;bot=bot.next}return null},paperproto.forEach=function(callback,thisArg){for(var bot=this.bottom;bot;){if(!1===callback.call(thisArg,bot))return this;bot=bot.next}return this},paperproto.getElementsByPoint=function(x,y){var set=this.set();return this.forEach(function(el){el.isPointInside(x,y)&&set.push(el)}),set},elproto.isPointInside=function(x,y){
var rp=this.realPath=getPath[this.type](this);return this.attr("transform")&&this.attr("transform").length&&(rp=R.transformPath(rp,this.attr("transform"))),R.isPointInsidePath(rp,x,y)},elproto.getBBox=function(isWithoutTransform){if(this.removed)return{};var _=this._;return isWithoutTransform?(!_.dirty&&_.bboxwt||(this.realPath=getPath[this.type](this),_.bboxwt=pathDimensions(this.realPath),_.bboxwt.toString=x_y_w_h,_.dirty=0),_.bboxwt):((_.dirty||_.dirtyT||!_.bbox)&&(!_.dirty&&this.realPath||(_.bboxwt=0,this.realPath=getPath[this.type](this)),_.bbox=pathDimensions(mapPath(this.realPath,this.matrix)),_.bbox.toString=x_y_w_h,_.dirty=_.dirtyT=0),_.bbox)},
elproto.clone=function(){if(this.removed)return null;var out=this.paper[this.type]().attr(this.attr());return this.__set__&&this.__set__.push(out),out},elproto.glow=function(glow){if("text"==this.type)return null;glow=glow||{};var s={width:(glow.width||10)+(+this.attr("stroke-width")||1),fill:glow.fill||!1,opacity:null==glow.opacity?.5:glow.opacity,offsetx:glow.offsetx||0,offsety:glow.offsety||0,color:glow.color||"#000"},c=s.width/2,r=this.paper,out=r.set(),path=this.realPath||getPath[this.type](this);path=this.matrix?mapPath(path,this.matrix):path;for(var i=1;i<c+1;i++)out.push(r.path(path).attr({stroke:s.color,fill:s.fill?s.color:"none",
"stroke-linejoin":"round","stroke-linecap":"round","stroke-width":+(s.width/c*i).toFixed(3),opacity:+(s.opacity/c).toFixed(3)}));return out.insertBefore(this).translate(s.offsetx,s.offsety)};var getPointAtSegmentLength=function(p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y,length){return null==length?bezlen(p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y):R.findDotsAtSegment(p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y,getTatLen(p1x,p1y,c1x,c1y,c2x,c2y,p2x,p2y,length))},getLengthFactory=function(istotal,subpath){return function(path,length,onlystart){path=path2curve(path);for(var x,y,p,l,point,sp="",subpaths={},len=0,i=0,ii=path.length;i<ii;i++){if(p=path[i],"M"==p[0])x=+p[1],y=+p[2];else{
if(l=getPointAtSegmentLength(x,y,p[1],p[2],p[3],p[4],p[5],p[6]),len+l>length){if(subpath&&!subpaths.start){if(point=getPointAtSegmentLength(x,y,p[1],p[2],p[3],p[4],p[5],p[6],length-len),sp+=["C"+point.start.x,point.start.y,point.m.x,point.m.y,point.x,point.y],onlystart)return sp;subpaths.start=sp,sp=["M"+point.x,point.y+"C"+point.n.x,point.n.y,point.end.x,point.end.y,p[5],p[6]].join(),len+=l,x=+p[5],y=+p[6];continue}if(!istotal&&!subpath)return point=getPointAtSegmentLength(x,y,p[1],p[2],p[3],p[4],p[5],p[6],length-len),{x:point.x,y:point.y,alpha:point.alpha}}len+=l,x=+p[5],y=+p[6]}sp+=p.shift()+p}return subpaths.end=sp,
point=istotal?len:subpath?subpaths:R.findDotsAtSegment(x,y,p[0],p[1],p[2],p[3],p[4],p[5],1),point.alpha&&(point={x:point.x,y:point.y,alpha:point.alpha}),point}},getTotalLength=getLengthFactory(1),getPointAtLength=getLengthFactory(),getSubpathsAtLength=getLengthFactory(0,1);R.getTotalLength=getTotalLength,R.getPointAtLength=getPointAtLength,R.getSubpath=function(path,from,to){if(this.getTotalLength(path)-to<1e-6)return getSubpathsAtLength(path,from).end;var a=getSubpathsAtLength(path,to,1);return from?getSubpathsAtLength(a,from).end:a},elproto.getTotalLength=function(){var path=this.getPath()
...
var q=.48-n/1.04,Q=math.sqrt(.1734+q*q),x=Q-q,X=pow(abs(x),1/3)*(x<0?-1:1),y=-Q-q,Y=pow(abs(y),1/3)*(y<0?-1:1),t=X+Y+.5;return 3*(1-t)*t*t+t*t*t},backIn:function(n){var s=1.70158;return n*n*((s+1)*n-s)},backOut:function(n){n-=1;var s=1.70158;return n*n*((s+1)*n+s)+1},elastic:function(n){return n==!!n?n:pow(2,-10*n)*math.sin(2*PI*(n-.075)/.3)+1},bounce:function(n){var l,s=7.5625,p=2.75;return n<1/p?l=s*n*n:n<2/p?(n-=1.5/p,l=s*n*n+.75):n<2.5/p?(n-=2.25/p,l=s*n*n+.9375):(n-=2.625/p,l=s*n*n+.984375),l}};ef.easeIn=ef["ease-in"]=ef["<"],ef.easeOut=ef["ease-out"]=ef[">"],ef.easeInOut=ef["ease-in-out"]=ef["<>"],ef["back-in"]=ef.backIn,ef["back-out"]=ef.backOut
;var animationElements=[],requestAnimFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(callback){setTimeout(callback,16)},animation=function(){for(var Now=+new Date,l=0;l<animationElements.length;l++){var e=animationElements[l];if(!e.el.removed&&!e.paused){var now,key,time=Now-e.start,ms=e.ms,easing=e.easing,from=e.from,diff=e.diff,to=e.to,that=(e.t,e.el),set={},init={};if(e.initstatus?(time=(e.initstatus*e.anim.top-e.prev)/(e.percent-e.prev)*ms,e.status=e.initstatus,delete e.initstatus,
e.stop&&animationElements.splice(l--,1)):e.status=(e.prev+(e.percent-e.prev)*(time/ms))/e.anim.top,!(time<0))if(time<ms){var pos=easing(time/ms);for(var attr in from)if(from[has](attr)){switch(availableAnimAttrs[attr]){case nu:now=+from[attr]+pos*ms*diff[attr];break;case"colour":now="rgb("+[upto255(round(from[attr].r+pos*ms*diff[attr].r)),upto255(round(from[attr].g+pos*ms*diff[attr].g)),upto255(round(from[attr].b+pos*ms*diff[attr].b))].join(",")+")";break;case"path":now=[];for(var i=0,ii=from[attr].length;i<ii;i++){now[i]=[from[attr][i][0]];for(var j=1,jj=from[attr][i].length;j<jj;j++)now[i][j]=+from[attr][i][j]+pos*ms*diff[attr][i][j];now[i]=now[i].join(S)}
now=now.join(S);break;case"transform":if(diff[attr].real)for(now=[],i=0,ii=from[attr].length;i<ii;i++)for(now[i]=[from[attr][i][0]],j=1,jj=from[attr][i].length;j<jj;j++)now[i][j]=from[attr][i][j]+pos*ms*diff[attr][i][j];else{var get=function(i){return+from[attr][i]+pos*ms*diff[attr][i]};now=[["m",get(0),get(1),get(2),get(3),get(4),get(5)]]}break;case"csv":if("clip-rect"==attr)for(now=[],i=4;i--;)now[i]=+from[attr][i]+pos*ms*diff[attr][i];break;default:var from2=[][concat](from[attr]);for(now=[],i=that.paper.customAttributes[attr].length;i--;)now[i]=+from2[i]+pos*ms*diff[attr][i]}set[attr]=now}that.attr(set),function(id,that,anim){setTimeout(function(){
eve("raphael.anim.frame."+id,that,anim)})}(that.id,that,e.anim)}else{if(function(f,el,a){setTimeout(function(){eve("raphael.anim.frame."+el.id,el,a),eve("raphael.anim.finish."+el.id,el,a),R.is(f,"function")&&f.call(el)})}(e.callback,that,e.anim),that.attr(to),animationElements.splice(l--,1),e.repeat>1&&!e.next){for(key in to)to[has](key)&&(init[key]=e.totalOrigin[key]);e.el.attr(init),runAnimation(e.anim,e.el,e.anim.percents[0],null,e.totalOrigin,e.repeat-1)}e.next&&!e.stop&&runAnimation(e.anim,e.el,e.next,null,e.totalOrigin,e.repeat)}}}animationElements.length&&requestAnimFrame(animation)},upto255=function(color){return color>255?255:color<0?0:color}
;elproto.animateWith=function(el,anim,params,ms,easing,callback){var element=this;if(element.removed)return callback&&callback.call(element),element;var a=params instanceof Animation?params:R.animation(params,ms,easing,callback);runAnimation(a,element,a.percents[0],null,element.attr());for(var i=0,ii=animationElements.length;i<ii;i++)if(animationElements[i].anim==anim&&animationElements[i].el==el){animationElements[ii-1].start=animationElements[i].start;break}return element},elproto.onAnimation=function(f){return f?eve.on("raphael.anim.frame."+this.id,f):eve.unbind("raphael.anim.frame."+this.id),this},Animation.prototype.delay=function(delay){
var a=new Animation(this.anim,this.ms);return a.times=this.times,a.del=+delay||0,a},Animation.prototype.repeat=function(times){var a=new Animation(this.anim,this.ms);return a.del=this.del,a.times=math.floor(mmax(times,0))||1,a},R.animation=function(params,ms,easing,callback){if(params instanceof Animation)return params;!R.is(easing,"function")&&easing||(callback=callback||easing||null,easing=null),params=Object(params),ms=+ms||0;var json,attr,p={};for(attr in params)params[has](attr)&&toFloat(attr)!=attr&&toFloat(attr)+"%"!=attr&&(json=!0,p[attr]=params[attr]);if(json)return easing&&(p.easing=easing),callback&&(p.callback=callback),new Animation({100:p},ms)
;if(callback){var lastKey=0;for(var i in params){var percent=toInt(i);params[has](i)&&percent>lastKey&&(lastKey=percent)}lastKey+="%",!params[lastKey].callback&&(params[lastKey].callback=callback)}return new Animation(params,ms)},elproto.animate=function(params,ms,easing,callback){var element=this;if(element.removed)return callback&&callback.call(element),element;var anim=params instanceof Animation?params:R.animation(params,ms,easing,callback);return runAnimation(anim,element,anim.percents[0],null,element.attr()),element},elproto.setTime=function(anim,value){return anim&&null!=value&&this.status(anim,mmin(value,anim.ms)/anim.ms),this},
elproto.status=function(anim,value){var len,e,out=[],i=0;if(null!=value)return runAnimation(anim,this,-1,mmin(value,1)),this;for(len=animationElements.length;i<len;i++)if(e=animationElements[i],e.el.id==this.id&&(!anim||e.anim==anim)){if(anim)return e.status;out.push({anim:e.anim,status:e.status})}return anim?0:out},elproto.pause=function(anim){for(var i=0;i<animationElements.length;i++)animationElements[i].el.id!=this.id||anim&&animationElements[i].anim!=anim||!1!==eve("raphael.anim.pause."+this.id,this,animationElements[i].anim)&&(animationElements[i].paused=!0);return this},elproto.resume=function(anim){
for(var i=0;i<animationElements.length;i++)if(animationElements[i].el.id==this.id&&(!anim||animationElements[i].anim==anim)){var e=animationElements[i];!1!==eve("raphael.anim.resume."+this.id,this,e.anim)&&(delete e.paused,this.status(e.anim,e.status))}return this},elproto.stop=function(anim){for(var i=0;i<animationElements.length;i++)animationElements[i].el.id!=this.id||anim&&animationElements[i].anim!=anim||!1!==eve("raphael.anim.stop."+this.id,this,animationElements[i].anim)&&animationElements.splice(i--,1);return this},eve.on("raphael.remove",stopAnimation),eve.on("raphael.clear",stopAnimation),elproto.toString=function(){return"Raphaël’s object"}
;var Set=function(items){if(this.items=[],this.length=0,this.type="set",items)for(var i=0,ii=items.length;i<ii;i++)!items[i]||items[i].constructor!=elproto.constructor&&items[i].constructor!=Set||(this[this.items.length]=this.items[this.items.length]=items[i],this.length++)},setproto=Set.prototype;setproto.push=function(){for(var item,len,i=0,ii=arguments.length;i<ii;i++)!(item=arguments[i])||item.constructor!=elproto.constructor&&item.constructor!=Set||(len=this.items.length,this[len]=this.items[len]=item,this.length++);return this},setproto.pop=function(){return this.length&&delete this[this.length--],this.items.pop()},
setproto.forEach=function(callback,thisArg){for(var i=0,ii=this.items.length;i<ii;i++)if(!1===callback.call(thisArg,this.items[i],i))return this;return this};for(var method in elproto)elproto[has](method)&&(setproto[method]=function(methodname){return function(){var arg=arguments;return this.forEach(function(el){el[methodname][apply](el,arg)})}}(method));return setproto.attr=function(name,value){if(name&&R.is(name,array)&&R.is(name[0],"object"))for(var j=0,jj=name.length;j<jj;j++)this.items[j].attr(name[j]);else for(var i=0,ii=this.items.length;i<ii;i++)this.items[i].attr(name,value);return this},setproto.clear=function(){for(;this.length;)this.pop()},
setproto.splice=function(index,count,insertion){index=index<0?mmax(this.length+index,0):index,count=mmax(0,mmin(this.length-index,count));var i,tail=[],todel=[],args=[];for(i=2;i<arguments.length;i++)args.push(arguments[i]);for(i=0;i<count;i++)todel.push(this[index+i]);for(;i<this.length-index;i++)tail.push(this[index+i]);var arglen=args.length;for(i=0;i<arglen+tail.length;i++)this.items[index+i]=this[index+i]=i<arglen?args[i]:tail[i-arglen];for(i=this.items.length=this.length-=count-arglen;this[i];)delete this[i++];return new Set(todel)},setproto.exclude=function(el){for(var i=0,ii=this.length;i<ii;i++)if(this[i]==el)return this.splice(i,1),!0},
...
for(var x=[],y=[],x2=[],y2=[],i=this.items.length;i--;)if(!this.items[i].removed){var box=this.items[i].getBBox();x.push(box.x),y.push(box.y),x2.push(box.x+box.width),y2.push(box.y+box.height)}return x=mmin[apply](0,x),y=mmin[apply](0,y),x2=mmax[apply](0,x2),y2=mmax[apply](0,y2),{x:x,y:y,x2:x2,y2:y2,width:x2-x,height:y2-y}},setproto.clone=function(s){s=this.paper.set();for(var i=0,ii=this.items.length;i<ii;i++)s.push(this.items[i].clone());return s},setproto.toString=function(){return"Raphaël‘s set"},setproto.glow=function(glowConfig){var ret=this.paper.set();return this.forEach(function(shape,index){var g=shape.glow(glowConfig)
...
null==doc.readyState&&doc.addEventListener&&(doc.addEventListener("DOMContentLoaded",f=function(){doc.removeEventListener("DOMContentLoaded",f,!1),doc.readyState="complete"},!1),doc.readyState="loading"),isLoaded()}(document),R}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__))&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__)},function(module,exports){!function(glob){var current_event,has="hasOwnProperty",separator=/[\.\/]/,fun=function(){},numsort=function(a,b){return a-b},events={n:{}},eve=function(name,scope){var l,args=Array.prototype.slice.call(arguments,2),listeners=eve.listeners(name),z=0,f=!1,indexed=[],queue={};current_event=name
;for(var i=0,ii=listeners.length;i<ii;i++)"zIndex"in listeners[i]&&(indexed.push(listeners[i].zIndex),listeners[i].zIndex<0&&(queue[listeners[i].zIndex]=listeners[i]));for(indexed.sort(numsort);indexed[z]<0;)if(l=queue[indexed[z++]],l.apply(scope,args)===f)return f;for(i=0;i<ii;i++)if("zIndex"in(l=listeners[i]))if(l.zIndex==indexed[z]){if(l.apply(scope,args)===f)return f;do{if(z++,(l=queue[indexed[z]])&&l.apply(scope,args)===f)return f}while(l)}else queue[l.zIndex]=l;else if(l.apply(scope,args)===f)return f};eve.listeners=function(name){var item,items,k,i,ii,j,jj,nes,names=name.split(separator),e=events,es=[e],out=[];for(i=0,ii=names.length;i<ii;i++){
for(nes=[],j=0,jj=es.length;j<jj;j++)for(e=es[j].n,items=[e[names[i]],e["*"]],k=2;k--;)(item=items[k])&&(nes.push(item),out=out.concat(item.f||[]));es=nes}return out},eve.on=function(name,f){for(var names=name.split(separator),e=events,i=0,ii=names.length;i<ii;i++)e=e.n,!e[names[i]]&&(e[names[i]]={n:{}}),e=e[names[i]];for(e.f=e.f||[],i=0,ii=e.f.length;i<ii;i++)if(e.f[i]==f)return fun;return e.f.push(f),function(zIndex){+zIndex==+zIndex&&(f.zIndex=+zIndex)}},eve.nt=function(subname){return subname?new RegExp("(?:\\.|\\/|^)"+subname+"(?:\\.|\\/|$)").test(current_event):current_event},eve.unbind=function(name,f){
for(var e,key,splice,names=name.split(separator),cur=[events],i=0,ii=names.length;i<ii;i++)for(var j=0;j<cur.length;j+=splice.length-2){if(splice=[j,1],e=cur[j].n,"*"!=names[i])e[names[i]]&&splice.push(e[names[i]]);else for(key in e)e[has](key)&&splice.push(e[key]);cur.splice.apply(cur,splice)}for(i=0,ii=cur.length;i<ii;i++)for(e=cur[i];e.n;){if(f){if(e.f){for(i=0,ii=e.f.length;i<ii;i++)if(e.f[i]==f){e.f.splice(i,1);break}!e.f.length&&delete e.f}for(key in e.n)if(e.n[has](key)&&e.n[key].f){var funcs=e.n[key].f;for(i=0,ii=funcs.length;i<ii;i++)if(funcs[i]==f){funcs.splice(i,1);break}!funcs.length&&delete e.n[key].f}}else{delete e.f
;for(key in e.n)e.n[has](key)&&e.n[key].f&&delete e.n[key].f}e=e.n}},eve.version="0.2.4",eve.toString=function(){return"You are running Eve 0.2.4"},void 0!==module&&module.exports?module.exports=eve:glob.eve=eve}(this)},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;__WEBPACK_AMD_DEFINE_ARRAY__=[__webpack_require__(1)],void 0!==(__WEBPACK_AMD_DEFINE_RESULT__=function(R){if(!R||R.svg){var has="hasOwnProperty",Str=String,toFloat=parseFloat,toInt=parseInt,math=Math,mmax=math.max,abs=math.abs,pow=math.pow,separator=/[, ]+/,eve=R.eve,E="",S=" ",xlink="http://www.w3.org/1999/xlink",markers={
...
(params.path&&"path"==o.type||newpath)&&(node.path=path2vml(~Str(a.path).toLowerCase().indexOf("r")?R._pathToAbsolute(a.path):a.path),o._.dirty=1,"image"==o.type&&(o._.fillpos=[a.x,a.y],o._.fillsize=[a.width,a.height],setCoords(o,1,1,0,0,0))),"transform"in params&&o.transform(params.transform),isOval){var cx=+a.cx,cy=+a.cy,rx=+a.rx||+a.r||0,ry=+a.ry||+a.r||0;node.path=R.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x",round((cx-rx)*zoom),round((cy-ry)*zoom),round((cx+rx)*zoom),round((cy+ry)*zoom),round(cx*zoom)),o._.dirty=1}if("clip-rect"in params){var rect=Str(params["clip-rect"]).split(separator);if(4==rect.length){rect[2]=+rect[2]+ +rect[0],
rect[3]=+rect[3]+ +rect[1];var div=node.clipRect||R._g.doc.createElement("div"),dstyle=div.style;dstyle.clip=R.format("rect({1}px {2}px {3}px {0}px)",rect),node.clipRect||(dstyle.position="absolute",dstyle.top=0,dstyle.left=0,dstyle.width=o.paper.width+"px",dstyle.height=o.paper.height+"px",node.parentNode.insertBefore(div,node),div.appendChild(node),node.clipRect=div)}params["clip-rect"]||node.clipRect&&(node.clipRect.style.clip="auto")}if(o.textpath){var textpathStyle=o.textpath.style;params.font&&(textpathStyle.font=params.font),params["font-family"]&&(textpathStyle.fontFamily='"'+params["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g,E)+'"'),
params["font-size"]&&(textpathStyle.fontSize=params["font-size"]),params["font-weight"]&&(textpathStyle.fontWeight=params["font-weight"]),params["font-style"]&&(textpathStyle.fontStyle=params["font-style"])}if("arrow-start"in params&&addArrow(res,params["arrow-start"]),"arrow-end"in params&&addArrow(res,params["arrow-end"],1),null!=params.opacity||null!=params.fill||null!=params.src||null!=params.stroke||null!=params["stroke-width"]||null!=params["stroke-opacity"]||null!=params["fill-opacity"]||null!=params["stroke-dasharray"]||null!=params["stroke-miterlimit"]||null!=params["stroke-linejoin"]||null!=params["stroke-linecap"]){
var fill=node.getElementsByTagName("fill");if(fill=fill&&fill[0],!fill&&(fill=createNode("fill")),"image"==o.type&&params.src&&(fill.src=params.src),params.fill&&(fill.on=!0),null!=fill.on&&"none"!=params.fill&&null!==params.fill||(fill.on=!1),fill.on&&params.fill){var isURL=Str(params.fill).match(R._ISURL);if(isURL){fill.parentNode==node&&node.removeChild(fill),fill.rotate=!0,fill.src=isURL[1],fill.type="tile";var bbox=o.getBBox(1);fill.position=bbox.x+S+bbox.y,o._.fillpos=[bbox.x,bbox.y],R._preload(isURL[1],function(){o._.fillsize=[this.offsetWidth,this.offsetHeight]})}else fill.color=R.getRGB(params.fill).hex,fill.src=E,fill.type="solid",
R.getRGB(params.fill).error&&(res.type in{circle:1,ellipse:1}||"r"!=Str(params.fill).charAt())&&addGradientFill(res,params.fill,fill)&&(a.fill="none",a.gradient=params.fill,fill.rotate=!1)}if("fill-opacity"in params||"opacity"in params){var opacity=((+a["fill-opacity"]+1||2)-1)*((+a.opacity+1||2)-1)*((+R.getRGB(params.fill).o+1||2)-1);opacity=mmin(mmax(opacity,0),1),fill.opacity=opacity,fill.src&&(fill.color="none")}node.appendChild(fill);var stroke=node.getElementsByTagName("stroke")&&node.getElementsByTagName("stroke")[0],newstroke=!1;!stroke&&(newstroke=stroke=createNode("stroke")),
(params.stroke&&"none"!=params.stroke||params["stroke-width"]||null!=params["stroke-opacity"]||params["stroke-dasharray"]||params["stroke-miterlimit"]||params["stroke-linejoin"]||params["stroke-linecap"])&&(stroke.on=!0),("none"==params.stroke||null===params.stroke||null==stroke.on||0==params.stroke||0==params["stroke-width"])&&(stroke.on=!1);var strokeColor=R.getRGB(params.stroke);stroke.on&&params.stroke&&(stroke.color=strokeColor.hex),opacity=((+a["stroke-opacity"]+1||2)-1)*((+a.opacity+1||2)-1)*((+strokeColor.o+1||2)-1);var width=.75*(toFloat(params["stroke-width"])||1);if(opacity=mmin(mmax(opacity,0),1),
null==params["stroke-width"]&&(width=a["stroke-width"]),params["stroke-width"]&&(stroke.weight=width),width&&width<1&&(opacity*=width)&&(stroke.weight=1),stroke.opacity=opacity,params["stroke-linejoin"]&&(stroke.joinstyle=params["stroke-linejoin"]||"miter"),stroke.miterlimit=params["stroke-miterlimit"]||8,params["stroke-linecap"]&&(stroke.endcap="butt"==params["stroke-linecap"]?"flat":"square"==params["stroke-linecap"]?"square":"round"),"stroke-dasharray"in params){var dasharray={"-":"shortdash",".":"shortdot","-.":"shortdashdot","-..":"shortdashdotdot",". ":"dot","- ":"dash","--":"longdash","- .":"dashdot","--.":"longdashdot","--..":"longdashdotdot"}
;stroke.dashstyle=dasharray[has](params["stroke-dasharray"])?dasharray[params["stroke-dasharray"]]:E}newstroke&&node.appendChild(stroke)}if("text"==res.type){res.paper.canvas.style.display=E;var span=res.paper.span,fontSize=a.font&&a.font.match(/\d+(?:\.\d*)?(?=px)/);s=span.style,a.font&&(s.font=a.font),a["font-family"]&&(s.fontFamily=a["font-family"]),a["font-weight"]&&(s.fontWeight=a["font-weight"]),a["font-style"]&&(s.fontStyle=a["font-style"]),fontSize=toFloat(a["font-size"]||fontSize&&fontSize[0])||10,s.fontSize=100*fontSize+"px",
...
el.appendChild(skew),p.skew=skew,p.transform(E),p},R._engine.setSize=function(width,height){var cs=this.canvas.style;return this.width=width,this.height=height,width==+width&&(width+="px"),height==+height&&(height+="px"),cs.width=width,cs.height=height,cs.clip="rect(0 "+width+" "+height+" 0)",this._viewBox&&R._engine.setViewBox.apply(this,this._viewBox),this},R._engine.setViewBox=function(x,y,w,h,fit){R.eve("raphael.setViewBox",this,this._viewBox,[x,y,w,h,fit]);var H,W,paperSize=this.getSize(),width=paperSize.width,height=paperSize.height;return fit&&(H=height/h,W=width/w,w*H<width&&(x-=(width-w*H)/2/H),h*W<height&&(y-=(height-h*W)/2/W)),
this._viewBox=[x,y,w,h,!!fit],this._viewBoxShift={dx:-x,dy:-y,scale:paperSize},this.forEach(function(el){el.transform("...")}),this};var createNode;R._engine.initWin=function(win){var doc=win.document;doc.styleSheets.length<31?doc.createStyleSheet().addRule(".rvml","behavior:url(#default#VML)"):doc.styleSheets[0].addRule(".rvml","behavior:url(#default#VML)");try{!doc.namespaces.rvml&&doc.namespaces.add("rvml","urn:schemas-microsoft-com:vml"),createNode=function(tagName){return doc.createElement("<rvml:"+tagName+' class="rvml">')}}catch(e){createNode=function(tagName){return doc.createElement("<"+tagName+' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')
...
this.canvas.appendChild(this.span),this.bottom=this.top=null},R.prototype.remove=function(){R.eve("raphael.remove",this),this.canvas.parentNode.removeChild(this.canvas);for(var i in this)this[i]="function"==typeof this[i]?R._removedFactory(i):null;return!0};var setproto=R.st;for(var method in elproto)elproto[has](method)&&!setproto[has](method)&&(setproto[method]=function(methodname){return function(){var arg=arguments;return this.forEach(function(el){el[methodname].apply(el,arg)})}}(method))}}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__))&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__)}])}),
define("taoQtiItem/portableLib/OAT/scale.raphael",["taoQtiItem/portableLib/jquery_2_1_1","taoQtiItem/portableLib/raphael"],function($,Raphael){return function(container,width,height){var wrapper=container.style?container:document.getElementById(container);wrapper.style.position||(wrapper.style.position="relative"),wrapper.style.width=width+"px",wrapper.style.height=height+"px";var nestedWrapper;"VML"===Raphael.type?(wrapper.innerHTML="<rvml:group style='position : absolute; width: 1000px; height: 1000px; top: 0px; left: 0px' coordsize='1000,1000' class='rvml'></rvml:group>",
nestedWrapper=$(".rvml",$(wrapper))[0]):(wrapper.innerHTML="<div class='svggroup'></div>",nestedWrapper=$(".svggroup",$(wrapper))[0]);var vmlDiv,paper=new Raphael(nestedWrapper,width,height);return"SVG"===Raphael.type?paper.canvas.setAttribute("viewBox","0 0 "+width+" "+height):vmlDiv=wrapper.getElementsByTagName("div")[0],paper.changeSize=function(w,h,center,clipping){clipping=!clipping;var ratioW=w/width,ratioH=h/height,scale=ratioW<ratioH?ratioW:ratioH,newHeight=parseInt(height*scale),newWidth=parseInt(width*scale);if("VML"===Raphael.type){var txt=document.getElementsByTagName("textpath");for(var i in txt){var curr=txt[i];if(curr.style){
if(!curr._fontSize){var mod=curr.style.font.split("px");curr._fontSize=parseInt(mod[0]),curr._font=mod[1]}curr.style.font=curr._fontSize*scale+"px"+curr._font}}var newSize;newSize=newWidth<newHeight?1e3*newWidth/width:1e3*newHeight/height,newSize=parseInt(newSize),nestedWrapper.style.width=newSize+"px",nestedWrapper.style.height=newSize+"px",clipping&&(nestedWrapper.style.left=parseInt((w-newWidth)/2)+"px",nestedWrapper.style.top=parseInt((h-newHeight)/2)+"px"),vmlDiv.style.overflow="visible"}clipping&&(newWidth=w,newHeight=h),wrapper.style.width=newWidth+"px",wrapper.style.height=newHeight+"px",paper.setSize(newWidth,newHeight),
center&&(wrapper.style.position="absolute",wrapper.style.left=parseInt((w-newWidth)/2)+"px",wrapper.style.top=parseInt((h-newHeight)/2)+"px")},paper.scaleAll=function(amount){paper.changeSize(width*amount,height*amount)},paper.changeSize(width,height),paper.w=width,paper.h=height,paper}}),define("parccTei/portableLib/axisFactory",["taoQtiItem/portableLib/lodash"],function(_){"use strict";function getArrowsPath(orientation,config){var tipPosition,arrowConfig={length:.7*config.unitSize,tip:.3*config.unitSize,orientation:orientation},axisSizePx=(config.max-config.min)*config.unitSize,path=""
;if("right"===arrowConfig.orientation)tipPosition=config.left+axisSizePx+arrowConfig.length,path+="M"+(config.left+axisSizePx)+","+config.top,path+="L"+tipPosition+","+config.top,path+="M"+(tipPosition-arrowConfig.tip)+","+(config.top+config.divisionWidth),path+="L"+tipPosition+","+config.top,path+="M"+(tipPosition-arrowConfig.tip)+","+(config.top-config.divisionWidth),path+="L"+tipPosition+","+config.top;else{if("left"!==arrowConfig.orientation)throw"unknown orientation type to the arrow";tipPosition=config.left-arrowConfig.length,path+="M"+config.left+","+config.top,path+="L"+tipPosition+","+config.top,
path+="M"+(tipPosition+arrowConfig.tip)+","+(config.top+config.divisionWidth),path+="L"+tipPosition+","+config.top,path+="M"+(tipPosition+arrowConfig.tip)+","+(config.top-config.divisionWidth),path+="L"+tipPosition+","+config.top}return path}function _applyStyle(path,config){path.attr({stroke:config.color?config.color:_defaults.color,"stroke-width":config.thickness?config.thickness:_defaults.thickness,opacity:config.opacity?config.opacity:_defaults.opacity})}function addCssClass(raphaelObj,newClass){var pattern=new RegExp("\\b"+newClass+"\\b"),oldClass=raphaelObj.node.getAttribute("class")||""
;raphaelObj.node.setAttribute("class",pattern.test(oldClass)?oldClass:oldClass+" "+newClass)}function getLabel(i,config){return config&&_.isArray(config.labels)&&void 0!==config.labels[i]&&!1!==config.labels[i]?config.labels[i]:i}function axisFactory(paper,config){config=_.defaults(config||{},_defaults);var arrowRight,arrowLeft,set=paper.set(),steps=[],obj={getMin:function(){return config.min},getMax:function(){return config.max},getCanvas:function(){return paper},getOriginPosition:function(){return{left:config.left-config.unitSize*config.min,top:config.top}},snap:function(x0){var step=config.unitSize/config.unitSubDivision
;return[paper.raphael.snapTo(steps,x0,step/2),config.top]},render:function(){this.clear();var path="M"+config.left+","+config.top,axisSizePx=(config.max-config.min)*config.unitSize,subDivisionSize=config.unitSize/config.unitSubDivision;path+="L"+(config.left+axisSizePx)+","+config.top;var position=config.left;steps.push(position);for(var i=config.min;i<=config.max;i++){path+="M"+position+","+(config.top-config.divisionWidth),path+="L"+position+","+(config.top+config.divisionWidth);var label=paper.text(position,config.top-config.divisionWidth-config.fontSize/2-5,getLabel(i,config));if(label.attr({"font-size":config.fontSize}),
addCssClass(label,"scene scene-text"),set.push(label),i<config.max){var subPosition=position+subDivisionSize;steps.push(subPosition);for(var j=config.unitSubDivision;j>1;j--)path+="M"+subPosition+","+(config.top-config.subDivisionWidth),path+="L"+subPosition+","+(config.top+config.subDivisionWidth),subPosition+=subDivisionSize,j!==config.unitSubDivision&&steps.push(subPosition)}position+=config.unitSize,steps.push(position)}config.arrows&&(arrowRight=this.buildArrow("right"),arrowLeft=this.buildArrow("left"));var pathObj=paper.path(path);addCssClass(pathObj,"scene scene-grid"),_applyStyle(pathObj,config),set.push(pathObj)},getSet:function(){return set},
isRendered:function(){return set.length},clear:function(){set.length>0&&(steps=[],set.remove().clear())},clickable:function(){var borderBox=set.getBBox(),clickableArea=paper.rect(borderBox.x,borderBox.y,borderBox.width,borderBox.height);return clickableArea.attr({fill:"rgba(0,0,0,0)",stroke:0}),set.push(clickableArea),clickableArea},getWidth:function(){return set.getBBox().width},getHeight:function(){return set.getBBox().height},getUnits:function(){return{x:config.unitSize,y:0}},coordinateToPosition:function(x){return{left:this.getOriginPosition().left+this.getUnits().x*x,top:this.getOriginPosition().top}},buildArrow:function(orientation){
var pathStr=getArrowsPath(orientation,config),arrow=paper.path(pathStr);return addCssClass(arrow,"scene scene-grid"),_applyStyle(arrow,config),set.push(arrow),arrow},getConfig:function(){return _.clone(config)},setConfig:function(key,value){config[key]=value},buildContainerBox:function(options){var _defaults={padding:20,absolute:!0,shadow:!1};options=_.defaults(options||{},_defaults);var box,padding=options.padding,bb=set.getBBox();if(options.absolute)box=paper.rect(bb.x-padding,bb.y-padding,bb.width+2*padding,bb.height+2*padding);else{var axisSizePx=(config.max-config.min)*config.unitSize
;box=paper.rect(config.left-padding,config.top-padding,axisSizePx+2*padding,config.divisionWidth+2*padding)}return box.attr({fill:"#fff"}),set.push(box),box.insertBefore(set),options&&options.shadow&&set.push(box.glow({width:5,fill:!0,offsetx:3,offsety:3,color:"#999"})),box},addCssClass:addCssClass};return obj.render(),obj}var _defaults={top:40,left:40,min:-5,max:5,labels:!1,thickness:2,color:"#000",divisionWidth:16,subDivisionWidth:8,unitSubDivision:2,unitSize:50,fontSize:18,arrows:!1,opacity:1};return axisFactory}),define("parccTei/portableLib/pointFactory",["taoQtiItem/portableLib/jquery_2_1_1","taoQtiItem/portableLib/lodash"],function($,_){"use strict"
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/arrow-open.svg",[],function(){
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-arrow.svg",[],function(){
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-close.svg",[],function(){
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-open.svg",[],function(){
return'<svg\n   xmlns:osb="http://www.openswatchbook.org/uri/2009/osb"\n   xmlns:dc="http://purl.org/dc/elements/1.1/"\n   xmlns:cc="http://creativecommons.org/ns#"\n   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n   xmlns:svg="http://www.w3.org/2000/svg"\n   xmlns="http://www.w3.org/2000/svg"\n   xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"\n   xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape"\n   width="50"\n   height="20"\n   viewbox="0 0 390.85715 160"\n   id="svg2"\n   version="1.1"\n   inkscape:version="0.48.4 r9939"\n   sodipodi:docname="open-open.svg">\n  <defs\n     id="defs4">\n    <linearGradient\n       id="linearGradient3788"\n       osb:paint="solid">\n      <stop\n         style="stop-color:#8c5959;stop-opacity:1;"\n         offset="0"\n         id="stop3790" />\n    </linearGradient>\n  </defs>\n  <sodipodi:namedview\n     id="base"\n     pagecolor="#ffffff"\n     bordercolor="#666666"\n     borderopacity="1.0"\n     inkscape:pageopacity="0.0"\n     inkscape:pageshadow="2"\n     inkscape:zoom="1.4"\n     inkscape:cx="248.80218"\n     inkscape:cy="-151.42361"\n     inkscape:document-units="px"\n     inkscape:current-layer="layer1"\n     showgrid="false"\n     inkscape:window-width="1920"\n     inkscape:window-height="1176"\n     inkscape:window-x="1920"\n     inkscape:window-y="24"\n     inkscape:window-maximized="1"\n     fit-margin-top="20"\n     fit-margin-left="20"\n     fit-margin-bottom="20"\n     fit-margin-right="20" />\n  <metadata\n     id="metadata7">\n    <rdf:RDF>\n      <cc:Work\n         rdf:about="">\n        <dc:format>image/svg+xml</dc:format>\n        <dc:type\n           rdf:resource="http://purl.org/dc/dcmitype/StillImage" />\n        <dc:title></dc:title>\n      </cc:Work>\n    </rdf:RDF>\n  </metadata>\n  <g\n     inkscape:label="Layer 1"\n     inkscape:groupmode="layer"\n     id="layer1"\n     transform="translate(-80.087587,-77.030866)">\n    <path\n       sodipodi:type="arc"\n       style="fill:#e6eef4;stroke:#e6eef4;stroke-width:17.50611686999999961;stroke-linecap:round;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none;fill-opacity:1"\n       id="path2985"\n       sodipodi:cx="488.57144"\n       sodipodi:cy="516.64789"\n       sodipodi:rx="57.142857"\n       sodipodi:ry="63.510082"\n       d="m 545.7143,516.64789 c 0,35.07565 -25.58373,63.51008 -57.14286,63.51008 -31.55913,0 -57.14285,-28.43443 -57.14285,-63.51008 0,-35.07565 25.58372,-63.51008 57.14285,-63.51008 31.50381,0 57.06456,28.33853 57.14268,63.35259"\n       sodipodi:start="0"\n       sodipodi:end="6.2807055"\n       transform="matrix(-0.91679254,0,0,0.82487918,608.00624,-269.14122)"\n       sodipodi:open="true" />\n    <path\n       style="fill:none;stroke:#e6eef4;stroke-width:16.15803146;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"\n       d="m 329.83454,158.05276 c -113.55503,0 -112.01007,0 -112.01007,0"\n       id="path3759"\n       inkscape:connector-curvature="0" />\n    <path\n       sodipodi:type="arc"\n       style="fill:none;stroke:#e6eef4;stroke-width:17.50611687;stroke-linecap:round;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"\n       id="path2985-5"\n       sodipodi:cx="488.57144"\n       sodipodi:cy="516.64789"\n       sodipodi:rx="57.142857"\n       sodipodi:ry="63.510082"\n       d="m 545.7143,516.64789 c 0,35.07565 -25.58373,63.51008 -57.14286,63.51008 -31.55913,0 -57.14285,-28.43443 -57.14285,-63.51008 0,-35.07565 25.58372,-63.51008 57.14285,-63.51008 31.50381,0 57.06456,28.33853 57.14268,63.35259"\n       sodipodi:start="0"\n       sodipodi:end="6.2807055"\n       transform="matrix(-0.91679254,0,0,0.82487918,838.86339,-269.14122)"\n       sodipodi:open="true" />\n  </g>\n</svg>\n'
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-arrow.svg",[],function(){
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-close.svg",[],function(){
...
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-open.svg",[],function(){
return'<svg\n   xmlns:osb="http://www.openswatchbook.org/uri/2009/osb"\n   xmlns:dc="http://purl.org/dc/elements/1.1/"\n   xmlns:cc="http://creativecommons.org/ns#"\n   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"\n   xmlns:svg="http://www.w3.org/2000/svg"\n   xmlns="http://www.w3.org/2000/svg"\n   xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"\n   xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape"\n   width="50"\n   height="20"\n   viewbox="0 0 390.85715 160"\n   id="svg2"\n   version="1.1"\n   inkscape:version="0.48.4 r9939"\n   sodipodi:docname="open-arrow.svg">\n  <defs\n     id="defs4">\n    <linearGradient\n       id="linearGradient3788"\n       osb:paint="solid">\n      <stop\n         style="stop-color:#8c5959;stop-opacity:1;"\n         offset="0"\n         id="stop3790" />\n    </linearGradient>\n  </defs>\n  <sodipodi:namedview\n     id="base"\n     pagecolor="#ffffff"\n     bordercolor="#666666"\n     borderopacity="1.0"\n     inkscape:pageopacity="0.0"\n     inkscape:pageshadow="2"\n     inkscape:zoom="1.4"\n     inkscape:cx="248.80218"\n     inkscape:cy="-151.42361"\n     inkscape:document-units="px"\n     inkscape:current-layer="layer1"\n     showgrid="false"\n     inkscape:window-width="1920"\n     inkscape:window-height="1176"\n     inkscape:window-x="1920"\n     inkscape:window-y="24"\n     inkscape:window-maximized="1"\n     fit-margin-top="20"\n     fit-margin-left="20"\n     fit-margin-bottom="20"\n     fit-margin-right="20" />\n  <metadata\n     id="metadata7">\n    <rdf:RDF>\n      <cc:Work\n         rdf:about="">\n        <dc:format>image/svg+xml</dc:format>\n        <dc:type\n           rdf:resource="http://purl.org/dc/dcmitype/StillImage" />\n        <dc:title></dc:title>\n      </cc:Work>\n    </rdf:RDF>\n  </metadata>\n  <g\n     inkscape:label="Layer 1"\n     inkscape:groupmode="layer"\n     id="layer1"\n     transform="translate(-80.087587,-77.030866)">\n    <path\n       sodipodi:type="arc"\n       style="fill:none;stroke:#e6eef4;stroke-width:17.50611687;stroke-linecap:round;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"\n       id="path2985"\n       sodipodi:cx="488.57144"\n       sodipodi:cy="516.64789"\n       sodipodi:rx="57.142857"\n       sodipodi:ry="63.510082"\n       d="m 545.7143,516.64789 c 0,35.07565 -25.58373,63.51008 -57.14286,63.51008 -31.55913,0 -57.14285,-28.43443 -57.14285,-63.51008 0,-35.07565 25.58372,-63.51008 57.14285,-63.51008 31.50381,0 57.06456,28.33853 57.14268,63.35259"\n       sodipodi:start="0"\n       sodipodi:end="6.2807055"\n       transform="matrix(-0.91679254,0,0,0.82487918,608.00624,-269.14122)"\n       sodipodi:open="true" />\n    <path\n       style="fill:none;stroke:#e6eef4;stroke-width:16.15803146;stroke-linecap:round;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"\n       d="m 329.83454,158.05276 c -113.55503,0 -112.01007,0 -112.01007,0"\n       id="path3759"\n       inkscape:connector-curvature="0" />\n    <path\n       sodipodi:type="arc"\n       style="fill:none;stroke:#e6eef4;stroke-width:17.50611687;stroke-linecap:round;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none"\n       id="path2985-5"\n       sodipodi:cx="488.57144"\n       sodipodi:cy="516.64789"\n       sodipodi:rx="57.142857"\n       sodipodi:ry="63.510082"\n       d="m 545.7143,516.64789 c 0,35.07565 -25.58373,63.51008 -57.14286,63.51008 -31.55913,0 -57.14285,-28.43443 -57.14285,-63.51008 0,-35.07565 25.58372,-63.51008 57.14285,-63.51008 31.50381,0 57.06456,28.33853 57.14268,63.35259"\n       sodipodi:start="0"\n       sodipodi:end="6.2807055"\n       transform="matrix(-0.91679254,0,0,0.82487918,838.86339,-269.14122)"\n       sodipodi:open="true" />\n  </g>\n</svg>\n'
}),define("text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/x-mark-circle.svg",[],function(){
return'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.995 511.995" xml:space="preserve"><path d="M437.126 74.939c-99.826-99.826-262.307-99.826-362.133 0C26.637 123.314 0 187.617 0 256.005s26.637 132.691 74.993 181.047c49.923 49.923 115.495 74.874 181.066 74.874s131.144-24.951 181.066-74.874c99.826-99.826 99.826-262.268.001-362.113zM409.08 409.006c-84.375 84.375-221.667 84.375-306.042 0-40.858-40.858-63.37-95.204-63.37-153.001s22.512-112.143 63.37-153.021c84.375-84.375 221.667-84.355 306.042 0 84.355 84.375 84.355 221.667 0 306.022z"/><path d="m341.525 310.827-56.151-56.071 56.151-56.071c7.735-7.735 7.735-20.29.02-28.046-7.755-7.775-20.31-7.755-28.065-.02l-56.19 56.111-56.19-56.111c-7.755-7.735-20.31-7.755-28.065.02-7.735 7.755-7.735 20.31.02 28.046l56.151 56.071-56.151 56.071c-7.755 7.735-7.755 20.29-.02 28.046 3.868 3.887 8.965 5.811 14.043 5.811s10.155-1.944 14.023-5.792l56.19-56.111 56.19 56.111c3.868 3.868 8.945 5.792 14.023 5.792a19.828 19.828 0 0 0 14.043-5.811c7.733-7.756 7.733-20.311-.022-28.046z"/></svg>'
}),define("css!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/css/graphNumberLineInteraction",[],function(){}),
define("graphNumberLineInteraction/runtime/graphNumberLineInteraction",["taoQtiItem/portableLib/jquery_2_1_1","qtiCustomInteractionContext","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/OAT/util/event","taoQtiItem/portableLib/OAT/scale.raphael","parccTei/portableLib/axisFactory","parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/libs/intervalFactory","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/markup/markup.html","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/arrow-close.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/arrow-open.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-arrow.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-close.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/close-open.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-arrow.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-close.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/open-open.svg","text!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/img/x-mark-circle.svg","css!parccTei/pciCreator/ims/graphNumberLineInteraction/runtime/css/graphNumberLineInteraction"],function($,qtiCustomInteractionContext,_,event,scaleRaphael,axisFactory,IntervalFactory,markup,arrowCloseSvg,arrowOpenSvg,closeArrowSvg,closeCloseSvg,closeOpenSvg,openArrowSvg,openCloseSvg,openOpenSvg,xMarkCircle){
"use strict";function createCanvas($container,config){var width=4+config.unitSize*(2+config.max-config.min);return scaleRaphael($(".shape-container",$container)[0],width,120)}function buildAxisConfig(rawConfig){var _default={top:60,left:50,unitSize:50,min:-5,max:5,unitSubDivision:2,arrows:!0,plot:{color:"#266d9c",thickness:5},point:{color:"#266d9c",radius:10}};return _.merge(_default,{min:void 0===rawConfig.min?void 0:parseInt(rawConfig.min),max:void 0===rawConfig.max?void 0:parseInt(rawConfig.max),unitSubDivision:void 0===rawConfig.unitSubDivision?void 0:parseInt(rawConfig.unitSubDivision),plot:{color:rawConfig.graphColor,
thickness:void 0===rawConfig.graphWidth?void 0:parseInt(rawConfig.graphWidth)},point:{color:rawConfig.graphColor,radius:10}})}function getAuthorizedIntervals(){return["closed-closed","closed-open","open-closed","open-open","arrow-open","arrow-closed","open-arrow","closed-arrow"]}var graphNumberLineInteraction;graphNumberLineInteraction={typeIdentifier:"graphNumberLineInteraction",getInstance:function(dom,config,state){var response=config.boundTo,responseIdentifier=Object.getOwnPropertyNames(response).pop();this.initialize(responseIdentifier,dom,config.properties);var responseValue=response[responseIdentifier];this.setResponse(responseValue),
this.setSerializedState(state),"function"==typeof config.onready&&config.onready(this,this.getState())},getState:function(){return this.getSerializedState()},oncompleted:function(){this.destroy()},getResponse:function(){var types=[],values=[],rawResponse=this.getRawResponse();return _.isArray(rawResponse)&&_.size(rawResponse)?(_.each(rawResponse,function(interval){types.push(interval.type),values.push([interval.start,interval.end])}),{record:[{name:"lineTypes",list:{string:types}},{name:"values",list:{pair:values}}]}):{base:null}},destroy:function(){$(this.dom).off().empty()},getTypeIdentifier:function(){return"graphNumberLineInteraction"},
initialize:function(id,dom,config){function initAxis($container,axisConfig){paper=createCanvas($container,axisConfig),axis=new axisFactory(paper,axisConfig),intervalFactory=new IntervalFactory(axis,axisConfig.plot)}function activate(uid){_.forIn(intervals,function(interval,id){id===uid?(interval.$control.find(".btn").removeClass("btn-info").addClass("btn-success"),interval.obj.enable()):(interval.$control.find(".btn").removeClass("btn-success").addClass("btn-info"),interval.obj.disable())})}function reset(){_.each(intervals,function(interval){interval.obj.destroy(),interval.$control.remove(),$intervalsOverlay.hide()}),intervals={}}
function setAvailableIntervals(availableIntervals){$intervalsAvailable.find(".interval-available").each(function(){var $this=$(this);_.indexOf(availableIntervals,$this.attr("value"))>=0?$this.addClass("activated"):$this.removeClass("activated")}),reset()}function setAxis(axisConfig){_this.axisConfig=buildAxisConfig(_.merge(_this.config,_this.axisConfig,axisConfig)),initAxis($container,_this.axisConfig),reset()}function createInterval(intervalType,start,end){var $button,uid,$svg,$tpl,interval;if(_.size(intervals)<selectionMax)return uid=_.uniqueId("interval_"),$button=$intervalsAvailable.find("button[value="+intervalType+"]"),$svg=$button.find("svg").clone(),
$tpl=$intervalTemplate.clone(),$tpl.find(".btn").append($svg),$tpl.attr("data-uid",uid),$intervalsSelected.append($tpl),interval=intervalFactory.plot(intervalType,start,end),intervals[uid]={type:intervalType,obj:interval,$control:$tpl},activate(uid),_.defer(function(){_this.trigger("responseChange",[_this.getRawResponse()])}),_.size(intervals)===selectionMax&&$intervalsOverlay.show(),interval}event.addEventMgr(this),this.id=id,this.dom=dom,this.config=config||{};var paper,axis,intervalFactory,icons,$container=$(dom),_this=this;icons={closeClose:closeCloseSvg,closeOpen:closeOpenSvg,openClose:openCloseSvg,openOpen:openOpenSvg,arrowOpen:arrowOpenSvg,
arrowClose:arrowCloseSvg,openArrow:openArrowSvg,closeArrow:closeArrowSvg,xMarkCircle:xMarkCircle},$container.append(Object.keys(icons).reduce(function(memo,iconName){return memo.replace(new RegExp("{{{"+iconName+"}}}","g"),icons[iconName])},markup)),this.reset=reset,this.axisConfig=buildAxisConfig(this.config),initAxis($container,this.axisConfig);var $intervalsAvailable=$container.find(".intervals-available"),$intervalsOverlay=$container.find(".intervals-overlay"),$intervalsSelected=$container.find(".intervals-selected"),$intervalTemplate=$container.find(".intervals-template .interval"),selectionMax=2,intervals={}
;setAvailableIntervals(this.config.intervals?this.config.intervals.split(","):getAuthorizedIntervals()),$container.on("click",".intervals-available .btn-info",function(){createInterval($(this).val(),0,1)}).on("click",".intervals-selected .btn-info",function(){activate($(this).parent(".interval").data("uid"))}).on("click",".intervals-selected .remove",function(){var $deleter=$(this),$parent=$deleter.parent(".interval"),uid=$parent.data("uid");intervals[uid].obj.destroy(),$parent.remove(),intervals=_.omit(intervals,uid),_.size(intervals)<=selectionMax&&$intervalsOverlay.hide(),_this.trigger("responseChange",[_this.getRawResponse()])
}).on("change.interval",function(){_this.trigger("responseChange",[_this.getRawResponse()])}),this.on("intervalschange",setAvailableIntervals),this.on("axischange",setAxis),this.getRawResponse=function(){var response=[];return _.each(intervals,function(interval){var coords=interval.obj.getCoordinates();response.push({type:interval.type,start:coords.start,end:coords.end})}),response},this.setRawResponse=function(intervals){_.isArray(intervals)&&_.each(intervals,function(interval){var start=interval.start,end=interval.end;null===start&&(start=end),createInterval(interval.type,start,end)})}},setResponse:function(response){
var i,point,lineTypes,values,rawResponse=[];if(response&&_.isArray(response.record)&&response.record[0]&&response.record[1]&&"lineTypes"===response.record[0].name&&response.record[0].list&&_.isArray(response.record[0].list.string)&&"values"===response.record[1].name&&response.record[1].list&&_.isArray(response.record[1].list.pair)&&response.record[0].list.length===response.record[1].list.length){for(lineTypes=response.record[0].list.string,values=response.record[1].list.pair,i=0;i<lineTypes.length;i++)point=values[i],rawResponse.push({type:lineTypes[i],start:point[0],end:point[1]});this.setRawResponse(rawResponse)}},resetResponse:function(){this.reset()},
setSerializedState:function(state){this.setResponse(state)},getSerializedState:function(){return this.getResponse()}},qtiCustomInteractionContext.register(graphNumberLineInteraction)}),function(c){var d=document,a="appendChild",i="styleSheet",s=d.createElement("style");s.type="text/css",d.getElementsByTagName("head")[0][a](s),s[i]?s[i].cssText=c:s[a](d.createTextNode(c))
}('.graphNumberLineInteraction{width:100%;padding:30px 30px 50px;margin:20px 0;padding:20px;border:6px solid #f5f3f2}.graphNumberLineInteraction .clearfix:before,.graphNumberLineInteraction .clearfix:after{content:" ";display:table}.graphNumberLineInteraction .clearfix:after{clear:both}.graphNumberLineInteraction .shape-controls .clearfix{overflow:auto}.graphNumberLineInteraction .shape-controls .intervals-available{float:left;position:relative;border:6px solid #f5f3f2;padding:4px;margin-right:10px;margin-bottom:10px}.graphNumberLineInteraction .shape-controls .intervals-available .intervals-overlay{position:absolute;width:100%;height:100%;top:0;left:0;background:#ddd;opacity:0.6;display:none}.graphNumberLineInteraction .shape-controls .intervals-available .interval-available{display:none}.graphNumberLineInteraction .shape-controls .intervals-available .interval-available.activated{display:inline-block}.graphNumberLineInteraction .shape-controls .intervals-selected{float:left}.graphNumberLineInteraction .shape-controls .intervals-selected .interval{float:left;position:relative;width:92px;border:6px solid #f5f3f2;padding:4px;margin-right:10px}.graphNumberLineInteraction .shape-controls .intervals-selected .interval .remove{cursor:pointer;text-decoration:none;color:#3e7da7;font-size:14px}.graphNumberLineInteraction .shape-controls .intervals-selected .interval .remove .icon svg{width:12px;margin-top:-5px;fill:#3e7da7}.graphNumberLineInteraction .shape-controls .intervals-selected .interval .btn{margin-bottom:10px}.graphNumberLineInteraction .shape-controls button{padding:0 6px 8px;height:36px;width:72px;margin-right:2px}.graphNumberLineInteraction .shape-controls .intervals-template{display:none}.graphNumberLineInteraction .shape-controls .intervals-row{margin-bottom:2px}.graphNumberLineInteraction .btn{color:#fff;border-radius:3px;border:none;font-size:14px;line-height:34px;outline:none;cursor:pointer}.graphNumberLineInteraction .btn:hover{opacity:.85}.graphNumberLineInteraction .btn.btn-info{background-color:#266d9c;text-shadow:1px 1px 0 #1e577d}.graphNumberLineInteraction .btn.btn-success{background-color:#269c5d;text-shadow:1px 1px 0 #1e7d4a}\n\n/*# sourceMappingURL=graphNumberLineInteraction.css.map */'),
